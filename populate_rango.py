...
def populate():
    python_pages = [
        ...
        {'title':'How to Think like a Computer Scientist','url':'http://www.greenteapress.com/thinkpython/', 'views':65},
    ...
    django_pages = [
        ...
        {'title':'Django Rocks', 'url':'http://www.djangorocks.com/', 'views':67},
        {'title':'How to Tango with Django', 'url':'http://www.tangowithdjango.com/', 'views':88} 
    ]
